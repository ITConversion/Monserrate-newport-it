...
exports.agendado = exports.agradecimientos = exports.apartmentsRender = exports.clubRender = exports.demohandler = exports.leadCreateOne = exports.leadGetMany = exports.landingCreateOne = exports.landingGetMany = exports.getMain = void 0;
...
const agradecimientos = (req, res) => {
    return res.render('thanks');
};
exports.agradecimientos = agradecimientos;
const agendado = (req, res) => {
    return res.render('scheduled');
};
exports.agendado = agendado;
